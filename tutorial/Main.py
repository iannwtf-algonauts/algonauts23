...
with open(f'{parent_output_dir}/{model_name}/results.txt', 'a') as results_file:
    for layer_name in layers:
        ...
        for subj in subjects:
            ...
            plot_file = f'correlations.png'
            Correlations.plot_correlations(dataset.data_dir, lh_correlation, rh_correlation, plot_file)
            print(f'Layer: {layer_name} Subject: {subj}', file=results_file)
            print(f'LH Correlation: {lh_correlation} RH Correlation: {rh_correlation}', file=results_file)
